...
!function(){"use strict";function t(t,n){t.containers=[],n.get("http://localhost:8080/containers/all").success(function(n){t.containers=n}).error(function(){console.log("failure")})}t.$inject=["$scope","$http"],angular.module("RDash").controller("ContainersCtrl",["$scope","$http",t])}();
!function(){"use strict";function t(t,e){t.images=[],e.get("http://localhost:8080/images/all").success(function(e){t.images=e}).error(function(){console.log("failure")})}t.$inject=["$scope","$http"],angular.module("RDash").controller("ImagesCtrl",["$scope","$http",t])}();

...
!function(){"use strict";function n(n,t){n.containers=[],t.get("/containers/all").success(function(t){n.containers=t}).error(function(){console.log("failure")})}n.$inject=["$scope","$http"],angular.module("RDash").controller("ContainersCtrl",["$scope","$http",n])}();
!function(){"use strict";function e(e,t){e.images=[],t.get("/images/all").success(function(t){e.images=t}).error(function(){console.log("failure")})}e.$inject=["$scope","$http"],angular.module("RDash").controller("ImagesCtrl",["$scope","$http",e])}();

...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html"}).state("list",{url:"/list",templateUrl:"templates/list.html"}).state("details",{url:"/details",templateUrl:"templates/details.html"}).state("images",{url:"/images",templateUrl:"templates/images.html"}).state("trash",{url:"/trash",templateUrl:"templates/trash.html"})}]);
...
!function(){"use strict";function n(n,o){n.containers=[],n.containersLoading=!0,o.get("/containers/all").success(function(o){n.containers=o}).error(function(){console.log("failure")})["finally"](function(){n.containersLoading=!1})}n.$inject=["$scope","$http"],angular.module("RDash").controller("ContainersCtrl",["$scope","$http",n])}();
